...
public class AboutUsActivity extends AppCompatActivity {
    ...
    private void setResult() {
        ...
        Picasso.get().load(Constant.IMAGE_URL + itemAbout.getAppLogo()).placeholder(R.drawable.place_holder_small).into(imgAppLogo);
        ...
        String text = "<html><head>"
                + "<style type=\"text/css\">@font-face {font-family: MyFont;src: url(\"file:///android_asset/myfonts/Poppins-Regular_0.ttf\")}body{font-family: MyFont;color: #8b8b8b;line-height:1.6}"
                + "</style></head>"
                + "<body>"
                + htmlText
                + "</body></html>";
