...
public class MyApplication extends Application {
    ...
    public void onCreate() {
        ...
        CalligraphyConfig.initDefault(new CalligraphyConfig.Builder()
                .setDefaultFontPath("myfonts/Poppins-Regular_0.ttf")
    ...
    private class ExampleNotificationOpenedHandler implements OneSignal.NotificationOpenedHandler {
        ...
        public void notificationOpened(OSNotificationOpenResult result) {
            ...
            if (data != null) {
                customKey = data.optString("new_id", null);
                Constant.NEWS_ID = customKey;
                isExternalLink = data.optString("external_link", null);
                if (customKey != null) {
                    if (!customKey.equals("0")) {
                        Intent intent = new Intent(MyApplication.this, NewsDetailActivity.class);
